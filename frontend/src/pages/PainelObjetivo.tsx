...
const PainelObjetivo = () => {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        const response = await fetch("http:// https://noncomprehendingly-unrescissable-ismael.ngrok-free.dev/painel-objetivo/opcoes");
        if (response.ok) {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const response = await fetch("http:// https://noncomprehendingly-unrescissable-ismael.ngrok-free.dev/painel-objetivo", {
        method: "POST",
